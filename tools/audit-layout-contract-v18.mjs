...
must(boot.includes('/assets/css/fluid-4k-rhythm.css?v=20260921-production-integrity-v29'),'render-stability cache token missing');
must(optimizer.includes('/assets/css/fluid-4k-rhythm.css?v=20260921-production-integrity-v29'),'production artifact must parser-discover the same canonical geometry CSS token');
