...
must(boot.includes('/assets/css/fluid-4k-rhythm.css?v=20260917-visual-repair-v29'),'visual repair cache token missing');
must(optimizer.includes('/assets/css/fluid-4k-rhythm.css?v=20260917-visual-repair-v29'),'production artifact must parser-discover the same canonical geometry CSS token');
