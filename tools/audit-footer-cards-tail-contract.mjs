...
must(Number(footer.paddingTopPx)===24&&Number(footer.paddingBottomPx)===16,'wide desktop footer root padding changed');
must(Number(footer.desktopRowGapMinPx)===28&&Number(footer.desktopRowGapMaxPx)===36,'wide desktop footer row gap changed');
must(Number(footer.desktopFooterBottomMarginPx)===18&&Number(footer.desktopFooterBottomPaddingPx)===10,'footer-bottom compact rhythm changed');
...
must(v29.includes('padding:clamp(24px,2vw,32px) 0 16px!important'),'v29 wide-desktop root padding drifted');
must(v29.includes('row-gap:clamp(28px,2vw,36px)!important'),'v29 wide-desktop row gap drifted');
