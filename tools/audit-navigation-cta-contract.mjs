...
if(menuCorePath!=='assets/js/mega-menu.js'){
  if(!/mega-menu-v65-base\.js\?v=20260917-[a-z0-9-]+/.test(menuLoader))failures.push('v31 mega-menu loader lost canonical core handoff');
...
console.log('Navigation/CTA contract passed: canonical routes, descriptive CTAs, v31 menu loader integrity and service-first EN/HU/DE navigation hierarchy are release-blocking.');
