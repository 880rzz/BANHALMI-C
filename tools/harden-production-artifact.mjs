...
if ((fluidCss.match(/FOOTER-SINGLE-CANONICAL-V42-20260925/g)||[]).length !== 1) throw new Error('BANHALMI canonical footer authority missing or duplicated during hardening.');
