...
if ((fluidCss.match(/FOOTER-SINGLE-CANONICAL-V41-20260924/g)||[]).length !== 1) throw new Error('BANHALMI canonical footer authority missing or duplicated during hardening.');
