...
for(const t of ['mega-menu.css?v=20260921-menu-first-tap-v66','mega-menu.js?v=20260921-menu-first-tap-v66'])if(!config.includes(t))errors.push('stale menu cache token '+t);
